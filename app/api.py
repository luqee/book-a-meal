...
class SignUp(Resource):
    ...
    def post(self):
        ...
        result = bam_application.signup_user(username, email, password)
...
class Meals(Resource):
    ...
    def get(self):
        ...
        for option in options:
            meals.append({'name': option.name, 'price': option.price, 'meal_id': option.meal_id})
    ...
    def post(self):
        ...
        name = data['name']
        price = data['price']
        result = bam_application.add_meal_option(name, price)
        if result == 'added':
    ...
    def put(self, args):
        ...
        name = data['name']
        price = data['price']
        result = bam_application.update_meal_options(args['mealId'], name, price)
        if result == 'Updated':
